...
<FaTimes className="w-5 h-5 fill-black" {...({ className: "w-5 h-5 fill-black" } as React.SVGProps<SVGSVGElement>)} />
              ...
              <ul className="lg:flex lg:gap-x-10 text-black max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                ...
                <li className="max-lg:border-b max-lg:py-3">
                  <Link href="/blog" className="hover:text-amber-800  text-[15px] font-semibold  block">
                    Blog
                  </Link>
                </li>
...
<Sheet>
  ...
  <SheetContent>
    <hr className="px-1 h-[2px] w-[80%] absolute bottom-16" />
    <div className="p-4">
      ...
      <hr className="my-4" />
      <div className="flex justify-between w-[70%]  gap-4 items-center absolute bottom-20 ">
        <div className="text-sm font-semibold">Subtotal  <span>=</span></div>  
        <div className="text-xs font-semibold text-[#d4a200]">
          Rs. 250,000.00
        </div>
      </div>
      
      <div className="mt-56 flex gap-4 absolute bottom-4 justify-center items-center">
      <Link href={'/cart'}>
      <button className="flex-1 text-xs sm:text-sm py-2 px-6 sm:px-8 border-2 hover:bg-black hover:text-white  border-black rounded-full text-center">
          View Cart
        </button>
      </Link>
        <Link href={'/checkout'}> 
        <button className="flex-1 text-xs sm:text-sm py-2 px-6 sm:px-8 bg-black hover:bg-white hover:text-black hover:border-black hover:border-2 text-white rounded-full text-center">
          Checkout
        </button>
        </Link>
      </div>
