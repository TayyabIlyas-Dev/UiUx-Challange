...
const CartSecOne = () => {
  return (
    ...
    <div className="flex-1 bg-white rounded-lg shadow-md ">
      ...
      <div className="grid grid-cols-4 items-center gap-2 pt-3">
        ...
        <div className="flex items-center col-span-1 px-2">
          ...
          />
          <span className="ml-4 text-xs sm:text-sm font-medium hidden sm:block">Sofa</span>
        </div>
        {/* Price */}
        ...
        <div className="flex items-center justify-between col-span-1">
          <span className="text-gray-700 text-xs">Rs. 250,000</span>
          {/* Delete Button */}
    ...
    {/* Cart Totals */}
    <div className="bg-[#FFF9E5] rounded-lg shadow-md p-6 flex-1 max-w-sm w-full">
     ...
     <Link href={'/checkout'}>
     <button className="w-full py-2 px-4 border-2 border-black text-black font-medium  hover:bg-black hover:text-white transition">
        Check Out
      </button>
     </Link>
    </div>
